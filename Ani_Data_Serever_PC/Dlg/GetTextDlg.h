...
public:
	...
	CGetTextDlg(int maxchar = 20, LPCTSTR getnum = _T(""), LPCTSTR title = _T("Input the Value."), CWnd* pParent = NULL,
			     BOOL pwd = FALSE, BOOL btndisable = FALSE);   // standard constructor
	void InitDlg(int maxchar = 20, TCHAR* getnum = _T(""), TCHAR* title = _T("Input the Value."), CWnd* pParent = NULL,
		BOOL pwd = FALSE, BOOL btndisable = FALSE); //150414 JSLee

// Dialog Data
	//{{AFX_DATA(CGetTextDlg)
	enum { IDD = DLG_TEXT_BOX };
