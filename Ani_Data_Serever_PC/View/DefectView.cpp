...
void CDefectView::OnInitialList()
{
	...
	//{
	//	theApp.getMsgBox(MS_OK, _T("NO DFS INFO"), _T("NO DFS INFO"), _T("�� DFS����"));
	//	return;
	//}
...
void CDefectView::OnSelchangeCmbDefectCommand()
{
	...
	{
		CString strLog;
		strLog.Format(_T("[CDefectView::OnSelchangeCmbDefectCommand] ��ͣ??! iCmbValue=%d, m_vecDefectInfo.size()=%d"),
